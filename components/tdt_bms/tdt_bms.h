...
#include "esphome/components/tdt_modbus/tdt_modbus.h"

namespace esphome {
namespace tdt_bms {

class TDTBms : public PollingComponent, public tdt_modbus::TDTModbusDevice {
 public:
  ...
  void on_tdt_modbus_data(const std::vector<uint8_t> &data) override;
